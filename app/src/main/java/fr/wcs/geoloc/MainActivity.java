...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkPermission() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            ActivityCompat.requestPermissions(MainActivity.this, PERMISSIONS, PERMISSION_REQUEST_LOCALISATION);
            return;
        }
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_LOCALISATION: {
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(MainActivity.this, getResources().getString(R.string.permission_not_granted), Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
